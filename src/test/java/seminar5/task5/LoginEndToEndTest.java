...
/*
В данном коде проводится end-to-end тестирование процесса авторизации на веб-странице. Открывается страница
авторизации, находятся элементы ввода для логина и пароля, вводятся данные, находится и кликается кнопка входа,
затем проверяется успешность авторизации (например, наличие элемента, который появляется после авторизации).
После каждого теста завершается работа веб-драйвера.
 */
